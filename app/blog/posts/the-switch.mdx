---
title: 'The Switch'
summary: i've been using astro for a while now,
  but i've always been curious about the next.js ecosystem.
  i decided to give it a try and see how it compares to astro.
