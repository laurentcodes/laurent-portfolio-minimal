...
const workExperience = [
	{
		...
		role: 'Led the entire project development from conception to deployment, architecting the frontend infrastructure, implementing responsive design patterns, and optimizing user experience across all device types.',
		impact:
