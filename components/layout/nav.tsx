	...
	return (
		<aside className='mb-8 md:mb-12'>
			<div className='lg:sticky lg:top-20'>
				<nav className='rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm p-2 overflow-x-auto'>
						...
						{Object.entries(navItems).map(([path, { name }]) => {
							...
							return (
								<Link
									...
									href={path}
									className={`
										transition-all px-2 py-1.5 md:px-3 md:py-2 rounded-md text-xs md:text-sm font-medium text-center whitespace-nowrap flex-1
										${
											isActive
